<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">Cafe Inventory</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @endif
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('stocks.index') ? 'active' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('products.index') ? 'active' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('suppliers.index') ? 'active' : '' }}"
    ...
    <div class="sidenav-footer mx-4 ">
        ...
        <div class="card border-radius-md" id="sidenavCard">
            <div class="card-body  text-start  p-3 w-100">
                ...
                <div class="docs-info">
                    <h6 class="font-weight-bold up mb-2">ITT626</h6>
                    <p class="text-sm font-weight-normal">Back-End Technology</p>
                </div>
            </div>
        </div>
    </div>
